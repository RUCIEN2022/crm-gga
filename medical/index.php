...
document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/getfactures.php')
    ...
    setTimeout(() => {
        Swal.fire({
            ...
            preConfirm: (motifRejet) => {
                return fetch('http://localhost:8080/crm-gga/app/codes/api/v1/rejter_facture.php', {
                    method: 'POST',
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            fetch('http://localhost:8080/crm-gga/app/codes/api/v1/ajout_traitement_fact.php', {
                method: 'POST',
                headers: {'Content-Type': 'application/json'},
...
function fetchTraitements() {
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/getliste_traitement.php')
    .then(response => response.json())
    .then(data => {
...
function mettreAJourStatistiques() {
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/getplaintes.php')
        .then(response => response.json())
        .then(result => {
...
document.getElementById('btnPriseEnCharge').addEventListener('click', function () {
    ...
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/prise_en_charge_plainte.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
document.getElementById('btnTraitement').addEventListener('click', function () {
    ...
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/traite_plainte.php', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ idplainte: idplainte })
    })
...
document.getElementById('formPlainte').addEventListener('submit', function(e) {
    ...
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/ajoutplainte.php', {
        method: 'POST',
        body: formData
    })
    .then(async response => {
...
function fetchActes() {
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/get_actes.php')
    .then(response => response.json())
    .then(data => {
...
function affichestatActe() {
  fetch('http://localhost:8080/crm-gga/app/codes/api/v1/State-actes.php')
    .then(response => response.json())
    .then(data => {
...
document.getElementById('formActe').addEventListener('submit', function (e) {
  ...
  fetch('http://localhost:8080/crm-gga/app/codes/api/v1/insert_actes.php', {
    method: 'POST',
    body: formData
  })
    .then(res => res.json())
...
<script>
document.addEventListener('DOMContentLoaded', function () {
  fetch('http://localhost:8080/crm-gga/app/codes/api/v1/getPrestataires.php') // remplace par le bon chemin
    .then(response => response.json())
    .then(data => {
      if (data.status === 'success') {
