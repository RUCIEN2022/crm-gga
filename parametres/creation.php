...
>>>>>>> d60a8632ff91846efb6b7997d1252508779f844d
    ...
    fetch('http://localhost:8080/crm-gga/app/codes/api/v1/ggacontrat.php/create', {
        method: 'POST',
        headers: {
...
fetch('http://localhost:8080/crm-gga/app/codes/api/v1/intermediaire.php/liste')
    .then(response => response.json())
    .then(responseData => {
...
fetch('http://localhost:8080/crm-gga/app/codes/api/v1/api_client.php/rccm')
 ...
 //enregistrement contrat
    ...
    async function handleSubmit(event) {
        ...
        try {
            const response = await fetch('http://localhost:8080/crm-gga/app/codes/api/v1/ggacontrat/create', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
